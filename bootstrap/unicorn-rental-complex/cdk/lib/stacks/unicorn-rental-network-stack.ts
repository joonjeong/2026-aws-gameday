...
export class UnicornRentalNetworkStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: UnicornRentalNetworkStackProps) {
    ...
    new cdk.CfnOutput(this, 'PublicSubnetIds', {
      value: this.resources.publicSubnetIds.join(','),
      description: 'Public subnet IDs for the internet-facing Spring Boot application tier',
    });

    new cdk.CfnOutput(this, 'PrivateSubnetIds', {
      value: this.resources.privateSubnetIds.join(','),
      description: 'Private isolated subnet IDs for the Postgres tier',
    });
  }
}
